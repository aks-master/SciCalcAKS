...
public class CalculatorTest {
    ...
    public void testSquareRootFunc() {
        assertEquals(4.0, calculator.squareRootFunc(16), 0.0001); // sqrt(16) = 4
    ...
    public void testNaturalLogFun() {
        assertEquals(Math.log(2), calculator.naturalLogFun(2), 0.0001);  // ln(2) = Math.log(2)
        assertEquals(Math.log(10), calculator.naturalLogFun(10), 0.0001); // ln(10) = Math.log(10)
    }

    // Test for power function
    @Test
    public void testPowerFunc() {
        assertEquals(8, calculator.powerFunc(2, 3));   // 2^3 = 8
